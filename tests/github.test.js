...
describe("GitHub", () => {
  test("should show the microsoft/Playwright project in the search if you search for Playwright", async () => {
    await page.goto("https://github.com");
    await page.type('input[name="q"]', "Playwright");
    await page.press('input[name="q"]', "Enter");
    await expect(page).toHaveText(".repo-list", "microsoft/playwright")
  })
  test("should contain 'Playwright' in the project title", async () => {
